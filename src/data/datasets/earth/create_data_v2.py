...
# Constants
NUM_POINTS_PER_CONTINENT = 500  # Total points per continent
RADIUS = 1.0  # Normalized Earth radius
...
# Helper function to convert lat/lon to normalized 3D spherical coordinates
...
for continent in continents.keys():
    ...
    ax.scatter(
        ...
        c=continent_data["color"], label=continent, s=5
    )

# Customize plot
ax.set_title("Normalized Spherical Representation of the Earth by Continent")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
